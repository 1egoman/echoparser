# ------------------------------------------------------------------------------
# templ.coffee
# This file is a basic template parser similar to what's used for the amazon echo.
# A template string is a normal string with curly-delimited variables, like "hello {world}"
# Templates can be executed ("hello {world}" with {world: "foo"} makes "hello foo")
# Also, templates can be reverse-encoded ("hello foo" with template "hello {world}" makes {world: "foo"})
# ------------------------------------------------------------------------------
